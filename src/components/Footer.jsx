    ...
    <div className="bg-gray-900 text-white py-8">
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap mb-8 justify-between ">
          {/* About Us Section */}
          <div className="w-full md:w-1/4 lg:w-[20%] flex flex-col gap-4">
          ...
          {/* Quick Links Section */}
          <div className="w-full md:w-1/4 lg:w-[20%] pl-2">
          ...
          {/* SiteMap Section */}
          <div className="w-full md:w-1/4 lg:w-[20%]">
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            {/* Legal Links Section */}
            <div className="flex flex-col md:flex-row gap-4 text-center text-gray-400">
