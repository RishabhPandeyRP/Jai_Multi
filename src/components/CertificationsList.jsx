...
const Certificate = ({ title, description, additionalInfo, imgPath }) => {
  ...
  return (
    <>
      <div className="certificate-container flex flex-col-reverse justify-center items-center shadow-xl p-6 py-[5%] rounded-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out mb-0 gap-[50px] w-full"
        style={{
