        ...
        <div className="flex flex-col gap-5">
            <NavBar></NavBar>
                <div className="relative w-full h-[60vh]  border-green-600 mb-[0%]">
                    ...
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center  font-newspaper text-[31px] md:text-[38px] text-white font-bold w-[20%] z-0 ">
                    Get In Touch:
